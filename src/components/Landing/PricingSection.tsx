...
const tiers = [
  {
    ...
    features: [
      ...
      { text: 'BYOK included', included: true },
      ...
      { text: 'Signature finetunes', included: false },
      { text: 'Self-learning models', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Signature finetunes', included: true },
      { text: 'Self-learning models', included: false },
      { text: 'Priority support', included: false },
    ],
    cta: 'Coming Soon',
  },
  {
    ...
    features: [
      ...
      { text: 'New features first', included: true },
      { text: 'Signature finetunes', included: true },
      { text: 'Self-learning models', included: true },
...
const comparisonFeatures = [
  { name: 'BYOK mode', free: true, scribe: true, novelist: true, architect: true },
  ...
  { name: 'Signature finetunes', free: false, scribe: false, novelist: true, architect: true },
  { name: 'Self-learning models', free: false, scribe: false, novelist: false, architect: true },
